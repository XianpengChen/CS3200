...
<title><%= people.getFirstName()%></title>
<meta charset="UTF-8">
...
<div class="w3-content w3-padding" style="max-width:1564px">
    ...
    <div class="w3-container w3-padding-32">
        <h1 class="w3-border-bottom w3-border-light-grey w3-padding-16"><%= people.getFirstName() + " " + people.getLastName()%></h1>
    </div>

    <div class="w3-container w3-row-padding w3-grayscale" method="post">
        <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">Schedule</h2>
    ...
    <div class="w3-container w3-row-padding w3-grayscale" method="post">
        <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">Joined Committees</h2>
    ...
    <div class="w3-container w3-row-padding w3-grayscale" method="post">
        <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">Joined Blocs</h2>
        <% List<Bloc> blocs = (List<Bloc>) request.getAttribute("blocs");
            for (int i = 0; i < blocs.size(); i++) {%>
        <div class="w3-col l3 m6 w3-margin-bottom">
            <img src="//////////////" width="250px" height="250px">
            <h3><%= blocs.get(i).getName()%>
            </h3>
            <p>
            <form action="${pageContext.request.contextPath}/singleBloc" method="post">
                <button class="w3-button w3-black w3-section" value="<%= blocs.get(i).getBloc_id()%>" name="bloc_id">
                    More details
                </button>
            </form>
            </p>
