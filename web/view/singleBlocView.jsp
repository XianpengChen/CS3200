...
<html>
<%Bloc bloc = (Bloc) request.getAttribute("bloc");%>

<title><%= bloc.getName()%></title>
<meta charset="UTF-8">
...
<div class="w3-content w3-padding" style="max-width:1564px">
    ...
    <div class="w3-container w3-padding-32">
        <h1 class="w3-border-bottom w3-border-light-grey w3-padding-16">All members are here!</h1>
    </div>
    ...
    <div class="w3-container w3-padding-32">
        <h1 class="w3-border-bottom w3-border-light-grey w3-padding-16">Add a people to this Bloc</h1>
        <form action="${pageContext.request.contextPath}/addPeopleToBloc" method="post">
            ...
            <select class="w3-input w3-section w3-border" required name="currentBloc">
                <option value="<%= bloc.getBloc_id()%>"> <%= bloc.getName()%></option>
            </select>
            <input class="w3-button w3-black w3-section" type="submit" value="Add">
        </form>
    </div>
    <div class="w3-container w3-padding-32">
        <h1 class="w3-border-bottom w3-border-light-grey w3-padding-16">Remove a member from this Bloc</h1>
        <form action="${pageContext.request.contextPath}/removePeopleFromBloc" method="post">
            <select class="w3-input w3-section w3-border" required name="currentMember">
            ...
            <input class="w3-button w3-black w3-section" type="submit" value="Remove">
        </form>
    </div>
